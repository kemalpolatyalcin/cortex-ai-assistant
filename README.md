...
```bash
git clone [https://github.com/kemalpolatyalcin/cortex-ai-assistant.git](https://github.com/kemalpolatyalcin/cortex-ai-assistant.git)
...
python cortex_vision.py (Terminal 2)
Press the global hotkey: CTRL + ALT + S
